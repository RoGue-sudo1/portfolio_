         ...
         <Link
          ...
          <ul className='list-none hidden sm:flex flex-row gap-10'>
            {navLinks.map((link)=>{
              ...
              >
                {(link.id )==='resume'? <a href="https://drive.google.com/file/d/11syvtuQRjdowGC45wIpL_evQZZMtmwhA/view?usp=sharing" className='bg-[#915eff] p-2 text-white' rel="noreferrer" target="_blank">{link.title}</a> : <a href={`#${link.id}`}>{link.title}</a>}
              </li>
              )
            })}
